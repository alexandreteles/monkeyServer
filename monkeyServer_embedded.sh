...
echo "This script will install LMP stack (Linux, Monkey Web Server, PHP-FPM) on your machine."
...
--default-user=monkey \
--default-port=80 \
--enable-plugins=auth,liana,liana_ssl,logger,fastcgi,dirlisting,polarssl,palm,mandril,cheetah,reverse_proxy
